...
void main() {
  test('testing decimal type', () {
    ...
    check(sqlType.convertStringValueToProvidedType<String>('10.00'))
        .equals('10.00');
    check(sqlType.convertStringValueToProvidedType<String>('-10.00'))
        .equals('-10.00');
    check(sqlType.convertStringValueToProvidedType<String>('0')).equals('0');
    check(sqlType.convertStringValueToProvidedType<String>('9999.99'))
        .equals('9999.99');
    check(sqlType.convertStringValueToProvidedType<String>('1000123'))
        .equals('1000123');

    check(() => sqlType.convertStringValueToProvidedType<bool>('10.00'))
        .throws<Exception>();

    check(() => sqlType.convertStringValueToProvidedType<int>('10.00'))
        .throws<Exception>();

    check(() => sqlType.convertStringValueToProvidedType<double>('10.00'))
        .throws<Exception>();

    check(() => sqlType.convertStringValueToProvidedType<num>('10.00'))
        .throws<Exception>();
  });
  ...
  test('testing tiny type', () {
    ...
    check(sqlType.convertStringValueToProvidedType<double>('10', 1))
        .equals(10.00);
    check(sqlType.convertStringValueToProvidedType<num>('10', 1)).equals(10);
    check(sqlType.convertStringValueToProvidedType<String>('10', 1))
        .equals('10');

    check(() => sqlType.convertStringValueToProvidedType<bool>('1', 2))
        .throws<Exception>();
  });
  ...
  test('testing short type', () {
    ...
    check(() => sqlType.convertStringValueToProvidedType<bool>('1'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<bool>('0'))
        .throws<Exception>();
  });
  ...
  test('testing float type', () {
    ...
    check(() => sqlType.convertStringValueToProvidedType<int>('1.0'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<bool>('1.0'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<bool>('0.0'))
        .throws<Exception>();
  });
  ...
  test('testing timestamp type', () {
    ...
    check(sqlType.convertStringValueToProvidedType<String>('123451234'))
        .equals('123451234');

    check(() => sqlType.convertStringValueToProvidedType<int>('123451234'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<double>('123451234'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<num>('123451234'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<bool>('123451234'))
        .throws<Exception>();
  });
  ...
  test('testing date type', () {
    ...
    check(sqlType.convertStringValueToProvidedType<String>('2022-01-02'))
        .equals('2022-01-02');

    check(() => sqlType.convertStringValueToProvidedType<int>('2022-01-02'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<double>('2022-01-02'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<num>('2022-01-02'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<bool>('2022-01-02'))
        .throws<Exception>();
  });
  ...
  test('testing time type', () {
    ...
    check(sqlType.convertStringValueToProvidedType<String>('02:00:34'))
        .equals('02:00:34');

    check(() => sqlType.convertStringValueToProvidedType<int>('02:00:34'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<double>('02:00:34'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<num>('02:00:34'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<bool>('02:00:34'))
        .throws<Exception>();
  });
  ...
  test('testing year type', () {
    ...
    check(sqlType.convertStringValueToProvidedType<String>('2022'))
        .equals('2022');
    check(sqlType.convertStringValueToProvidedType<int>('2022')).equals(2022);

    check(sqlType.convertStringValueToProvidedType<double>('2022'))
        .equals(2022.0);
    check(sqlType.convertStringValueToProvidedType<num>('2022')).equals(2022);
    check(() => sqlType.convertStringValueToProvidedType<bool>('2022'))
        .throws<Exception>();
  });
  ...
  test('testing varchar type', () {
    ...
    check(sqlType.convertStringValueToProvidedType<String>('Some text'))
        .equals('Some text');

    check(sqlType.convertStringValueToProvidedType<String>('Какой-то текст'))
        .equals('Какой-то текст');

    check(() => sqlType.convertStringValueToProvidedType<int>('2022'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<double>('2022'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<num>('2022'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<bool>('2022'))
        .throws<Exception>();
  });
  ...
  test('testing enum type', () {
    ...
    check(sqlType.convertStringValueToProvidedType<String>('process'))
        .equals('process');

    check(() => sqlType.convertStringValueToProvidedType<int>('process'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<double>('process'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<num>('process'))
        .throws<Exception>();
    check(() => sqlType.convertStringValueToProvidedType<bool>('process'))
        .throws<Exception>();
  });
  ...
  test('testing unsupported type conversions', () {
    final sqlType = MySQLColumnType.stringType;
    check(() => sqlType.convertStringValueToProvidedType<List<int>>('test'))
        .throws<Exception>();
  });
}
